...
<%--                    <input type="checkbox" id="popItem${item.idx}" class="hidden" checked required>--%>
        ...
        <form id="titleContainer" action="/todo/update" method="post">
            <input type="hidden" name="idx" value="${todoObject.idx}">
            <div>
                <input type="text" placeholder="${todoObject.message}" name="msg" class="msg" autocomplete="off"/>
            </div>
            <div>
                <label class="name">${todoObject.userName}</label>
            </div>
            <div>
                <input type="password" placeholder="" name="pw" class="pw" autocomplete="off"/>
            </div>
            <div>
